...
The AP group is slightly better than NP group, for overall performance. In AP group, the second actor benefits from the game. It implies that, if they can both see the future and be more sly, it is similar to an involution in human society--- no one wins in involution. However, when one agent can see the future, it can always get much better results compared to other cars in the same situation without the foreseeability. 
